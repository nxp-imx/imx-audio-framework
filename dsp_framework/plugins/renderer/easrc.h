...
#define EASRC_RRL_RS_RL_MASK		(0xFFFFFFFF << EASRC_RRL_RS_RL_SHIFT)
...
#define EASRC_RSUC_RS_RM_MASK		(0xFFFFFFFF << EASRC_RSUC_RS_RM_SHIFT)
...
#define EASRC_RCTCL_RS_CL_MASK		(0xFFFFFFFF \
...
#define EASRC_RCTCH_RS_CH_MASK		(0xFFFFFFFF \
...
#define EASRC_PCF_CD_MASK		(0xFFFFFFFF \
					 << EASRC_PCF_CD_SHIFT)
...
#define EASRC_CRCM_RS_CWD_MASK		(0xFFFFFFFF \
...
#define EASRC_CSx_CSx_MASK		(0xFFFFFFFF \
					 << EASRC_CSx_CSx_SHIFT)
...
#define EASRC_DBGS_DS_MASK		(0xFFFFFFFF \
					 << EASRC_DBGS_DS_SHIFT)
...
#define EASRC_32b_MASK			(0xFFFFFFFF)
#define EASRC_64b_MASK			(0xFFFFFFFFFFFFFFFF)
...
void easrc_init(volatile void * asrc_addr, int mode, int channel, int rate,
