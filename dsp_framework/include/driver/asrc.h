...
void asrc_init(volatile void * asrc_addr, int mode, int channel, int rate,
...
void asrc_suspend(volatile void *asrc_addr,  UWORD32 *cache_addr);
void asrc_resume(volatile void *asrc_addr,  UWORD32 *cache_addr);
