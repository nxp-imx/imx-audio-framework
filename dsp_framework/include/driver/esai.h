...
void esai_init(volatile void * esai_addr, int mode, int channel, int rate, int width, int mclk_rate);
...
void esai_suspend(volatile void *esai_addr,  UWORD32 *cache_addr);
void esai_resume(volatile void *esai_addr,  UWORD32 *cache_addr);
#endif
