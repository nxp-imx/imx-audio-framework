/* This linker script generated from xt-genldscripts.tpp for LSP dsp_framework/memmap/imx8 */
/* Linker Script for default link */
MEMORY
{
  dram0_0_seg :                       	org = 0x596E8000, len = 0x8000
  dram1_0_seg :                       	org = 0x596F0000, len = 0x8000
  iram0_0_seg :                       	org = 0x596F8000, len = 0x2E0
  iram0_2_seg :                       	org = 0x596F8400, len = 0x178
  iram0_3_seg :                       	org = 0x596F8578, len = 0x4
  iram0_4_seg :                       	org = 0x596F857C, len = 0x1C
  iram0_5_seg :                       	org = 0x596F8598, len = 0x4
  iram0_6_seg :                       	org = 0x596F859C, len = 0x1C
  iram0_7_seg :                       	org = 0x596F85B8, len = 0x4
  iram0_8_seg :                       	org = 0x596F85BC, len = 0x1C
  iram0_9_seg :                       	org = 0x596F85D8, len = 0x4
  iram0_10_seg :                      	org = 0x596F85DC, len = 0x1C
  iram0_11_seg :                      	org = 0x596F85F8, len = 0x4
  iram0_12_seg :                      	org = 0x596F85FC, len = 0x1C
  iram0_13_seg :                      	org = 0x596F8618, len = 0x4
  iram0_14_seg :                      	org = 0x596F861C, len = 0x1C
  iram0_15_seg :                      	org = 0x596F8638, len = 0x4
  iram0_16_seg :                      	org = 0x596F863C, len = 0x1C
  iram0_17_seg :                      	org = 0x596F8658, len = 0x1A8
  sram0_seg :                         	org = 0x92400000, len = 0x800000
  srom0_seg :                         	org = 0x92C00000, len = 0x700000
}
...
_memmap_mem_dram0_start = 0x596e8000;
_memmap_mem_dram0_end   = 0x596f0000;
_memmap_mem_dram1_start = 0x596f0000;
_memmap_mem_dram1_end   = 0x596f8000;
_memmap_mem_iram0_start = 0x596f8000;
_memmap_mem_iram0_end   = 0x596f8800;
_memmap_mem_sram_start = 0x92400000;
_memmap_mem_sram_end   = 0x92c00000;
_memmap_mem_srom_start = 0x92c00000;
_memmap_mem_srom_end   = 0x93300000;

/*  Memory segment boundary addresses:  */
_memmap_seg_dram0_0_start = 0x596e8000;
_memmap_seg_dram0_0_max   = 0x596f0000;
_memmap_seg_dram1_0_start = 0x596f0000;
_memmap_seg_dram1_0_max   = 0x596f8000;
_memmap_seg_iram0_0_start = 0x596f8000;
_memmap_seg_iram0_0_max   = 0x596f82e0;
_memmap_seg_iram0_2_start = 0x596f8400;
_memmap_seg_iram0_2_max   = 0x596f8578;
_memmap_seg_iram0_3_start = 0x596f8578;
_memmap_seg_iram0_3_max   = 0x596f857c;
_memmap_seg_iram0_4_start = 0x596f857c;
_memmap_seg_iram0_4_max   = 0x596f8598;
_memmap_seg_iram0_5_start = 0x596f8598;
_memmap_seg_iram0_5_max   = 0x596f859c;
_memmap_seg_iram0_6_start = 0x596f859c;
_memmap_seg_iram0_6_max   = 0x596f85b8;
_memmap_seg_iram0_7_start = 0x596f85b8;
_memmap_seg_iram0_7_max   = 0x596f85bc;
_memmap_seg_iram0_8_start = 0x596f85bc;
_memmap_seg_iram0_8_max   = 0x596f85d8;
_memmap_seg_iram0_9_start = 0x596f85d8;
_memmap_seg_iram0_9_max   = 0x596f85dc;
_memmap_seg_iram0_10_start = 0x596f85dc;
_memmap_seg_iram0_10_max   = 0x596f85f8;
_memmap_seg_iram0_11_start = 0x596f85f8;
_memmap_seg_iram0_11_max   = 0x596f85fc;
_memmap_seg_iram0_12_start = 0x596f85fc;
_memmap_seg_iram0_12_max   = 0x596f8618;
_memmap_seg_iram0_13_start = 0x596f8618;
_memmap_seg_iram0_13_max   = 0x596f861c;
_memmap_seg_iram0_14_start = 0x596f861c;
_memmap_seg_iram0_14_max   = 0x596f8638;
_memmap_seg_iram0_15_start = 0x596f8638;
_memmap_seg_iram0_15_max   = 0x596f863c;
_memmap_seg_iram0_16_start = 0x596f863c;
_memmap_seg_iram0_16_max   = 0x596f8658;
_memmap_seg_iram0_17_start = 0x596f8658;
_memmap_seg_iram0_17_max   = 0x596f8800;
_memmap_seg_sram0_start = 0x92400000;
_memmap_seg_sram0_max   = 0x92c00000;
_memmap_seg_srom0_start = 0x92c00000;
_memmap_seg_srom0_max   = 0x93300000;

_rom_store_table = 0;
PROVIDE(_memmap_reset_vector = 0x596f8000);
PROVIDE(_memmap_vecbase_reset = 0x596f8400);
/* Various memory-map dependent cache attribute settings: */
_memmap_cacheattr_wb_base = 0x00040200;
_memmap_cacheattr_wt_base = 0x00010200;
_memmap_cacheattr_bp_base = 0x00020200;
_memmap_cacheattr_unused_mask = 0xFFF0F0FF;
_memmap_cacheattr_wb_trapnull = 0x2224222F;
_memmap_cacheattr_wba_trapnull = 0x2224222F;
_memmap_cacheattr_wbna_trapnull = 0x2225222F;
_memmap_cacheattr_wt_trapnull = 0x2221222F;
_memmap_cacheattr_bp_trapnull = 0x2222222F;
_memmap_cacheattr_wb_strict = 0xFFF4F2FF;
_memmap_cacheattr_wt_strict = 0xFFF1F2FF;
_memmap_cacheattr_bp_strict = 0xFFF2F2FF;
_memmap_cacheattr_wb_allvalid = 0x22242222;
_memmap_cacheattr_wt_allvalid = 0x22212222;
_memmap_cacheattr_bp_allvalid = 0x22222222;
_memmap_region_map = 0x00000014;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x92c00000);
  _heap_sentry = 0x92c00000;
